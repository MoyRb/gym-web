...
const benefits = ["Rutinas personalizadas gratis", "Cálculo de IMC en tiempo real", "Recursos PDF descargables"]
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="absolute -top-40 -left-40 -z-10 h-96 w-96 rounded-full bg-primary/10 blur-3xl" />
      ...
      <header className="flex h-16 items-center border-b border-border/40 bg-background/95 px-4 sm:px-6">
        <Link href="/" className="flex items-center gap-2 font-bold text-lg">
          ...
          <span><span className="text-primary">TITAN</span><span className="text-foreground">FIT</span></span>
        </Link>
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            <Badge variant="outline" className="mb-3 border-primary/30 bg-primary/5 text-primary">Gratis para siempre</Badge>
            <h1 className="text-3xl font-bold">Empieza hoy</h1>
            <p className="mt-2 text-muted-foreground">Crea tu cuenta y obtén tu plan personalizado en minutos</p>
          </div>
